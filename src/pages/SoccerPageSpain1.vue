...
// onBeforeUpdate(() => {
//   console.log('Current:', getCurrentLeague());
//   console.log('League id:', route.params.leagueId);
//   if (getCurrentLeague() !== String(route.params.leagueId)) {
//     // leagueKey.value++;
//     setCurrentLeague(route.params.leagueId as Leagues);
//   }
// });
