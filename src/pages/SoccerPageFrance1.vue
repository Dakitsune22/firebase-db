...
import { teamsFrance1 } from 'src/data/teams';
...
const restartLeague = async () => {
  // Rounds:
  // const rounds = generateLeagueCalendar(teamsFrance1);
  const rounds = createCalendar(teamsFrance1.length);
...
const onRestartLeague = () => {
  $q.dialog({
    html: true,
    title:
      '<span class="text-primary">Reiniciar Ligue 1</span> <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;"><img style="width: 30%; height: 30%; margin-top: 15px;" src="/images/leagues/france1.png" /></div>',
    message:
  ...
  <q-page v-else class="page-body">
    ...
    >
      ...
      <div class="round-header">
        ...
        <q-img
          src="/images/leagues/france1.png"
          spinner-color="white"
          width="30px"
          height="30px"
          class="q-ma-sm"
